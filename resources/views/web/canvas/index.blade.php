                ...
                <ul>    <!-- SLIDE  -->
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-delay="5000" data-saveperformance="off" data-title="Latest Collections" style="background-color: #F6F6F6;">
                        ...
                        <div class="tp-caption ltl tp-resizeme revo-slider-caps-text uppercase"
                             ...
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style=""><img src="{{ asset('web/canvas/images/slider/rev/shop/girl1.jpg')}}" alt="Girl"></div>
                    ...
                    <li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-delay="5000"  data-saveperformance="off"  data-title="Messenger bags" style="background-color: #E9E8E3;">
                        ...
                        <div class="tp-caption ltl tp-resizeme revo-slider-caps-text uppercase"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style=""><img src="{{ asset('web/canvas/images/slider/rev/shop/bag.png')}}" alt="Bag"></div>
                        ...
                        <div class="tp-caption utb tp-resizeme revo-slider-caps-text uppercase"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="1000"
                             data-endeasing="Power4.easeIn" style=""><img src="{{ asset('web/canvas/s/slider/rev/shop/tag.png')}}" alt="Bag"></div>
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-lg-6 norightpadding" style="margin-bottom: 15px;">
                                <a href="#"><img src="{{ asset('web/canvas/images/shop/banners/2.jpg')}}" alt="Image"></a>
                            </div>

                            <div class="col-lg-6 norightpadding" style="margin-bottom: 15px;">
                                <a href="#"><img src="{{ asset('web/canvas/images/shop/banners/8.jpg')}}" alt="Image"></a>
                            </div>

                            <div class="w-100"></div>

                            <div class="col-lg-12 norightpadding">
                                <a href="#"><img src="{{ asset('web/canvas/images/shop/banners/4.jpg')}}" alt="Image"></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <a href="#"><img src="{{ asset('web/canvas/images/shop/banners/9.jpg')}}" alt="Image"></a>
                    </div>
                </div>
                    ...
                    <div class="tab-container">
                            ...
                            <div id="shop" class="shop clearfix">
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/dress/1.jpg')}}" alt="Checked Short Dress"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/dress/1-1.jpg')}}" alt="Checked Short Dress"></a>
                                        <div class="sale-flash">50% Off*</div>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                                        </div>
                                    </div>
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/pants/1-1.jpg')}}" alt="Slim Fit Chinos"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/pants/1.jpg')}}" alt="Slim Fit Chinos"></a>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                                        </div>
                                        ...
                                        <div class="fslider" data-arrows="false">
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide"><a href="#"><img src="{{ asset('web/canvas/images/shop/shoes/1.jpg') }}" alt="Dark Brown Boots"></a></div>
                                                    <div class="slide"><a href="#"><img src="{{ asset('web/canvas/images/shop/shoes/1-1.jpg') }}" alt="Dark Brown Boots"></a></div>
                                                    <div class="slide"><a href="#"><img src="{{ asset('web/canvas/images/shop/shoes/1-2.jpg') }}" alt="Dark Brown Boots"></a></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-overlay">
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/dress/2.jpg') }}" alt="Light Blue Denim Dress"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/dress/2-2.jpg') }}" alt="Light Blue Denim Dress"></a>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                        ...
                        <div class="tab-content clearfix" id="tabs-10">
                            ...
                            <div id="shop" class="shop clearfix">
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/sunglasses/1.jpg') }}" alt="Unisex Sunglasses"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/sunglasses/1-1.jpg') }}" alt="Unisex Sunglasses"></a>
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/tshirts/1.jpg') }}" alt="Blue Round-Neck Tshirt"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/tshirts/1-1.jpg') }}" alt="Blue Round-Neck Tshirt"></a>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                                        </div>
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/watches/1.jpg') }}" alt="Silver Chrome Watch"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/watches/1-1.jpg') }}" alt="Silver Chrome Watch"></a>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                                        </div>
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/shoes/2.jpg') }}" alt="Men Grey Casual Shoes"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/shoes/2-1.jpg') }}" alt="Men Grey Casual Shoes"></a>
                                        <div class="sale-flash">Sale!</div>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                        ...
                        <div class="tab-content clearfix" id="tabs-11">
                            ...
                            <div id="shop" class="shop clearfix">
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <div class="fslider" data-arrows="false">
                                            <div class="flexslider">
                                                <div class="slider-wrap">
                                                    <div class="slide"><a href="#"><img src="{{ asset('web/canvas/images/shop/dress/3.jpg') }}" alt="Pink Printed Dress"></a></div>
                                                    <div class="slide"><a href="#"><img src="{{ asset('web/canvas/images/shop/dress/3-1.jpg') }}" alt="Pink Printed Dress"></a></div>
                                                    <div class="slide"><a href="#"><img src="{{ asset('web/canvas/images/shop/dress/3-2.jpg') }}" alt="Pink Printed Dress"></a></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-overlay">
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/pants/5.jpg') }}" alt="Green Trousers"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/pants/5-1.jpg') }}" alt="Green Trousers"></a>
                                        <div class="sale-flash">Sale!</div>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/sunglasses/2.jpg') }}" alt="Men Aviator Sunglasses"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/sunglasses/2-1.jpg') }}" alt="Men Aviator Sunglasses"></a>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                                        </div>
                                ...
                                <div class="product clearfix">
                                    <div class="product-image">
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/tshirts/4.jpg') }}" alt="Black Polo Tshirt"></a>
                                        <a href="#"><img src="{{ asset('web/canvas/images/shop/tshirts/4-1.jpg') }}" alt="Black Polo Tshirt"></a>
                                        <div class="product-overlay">
                                            <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                            <a href="{{ asset('web/canvas/include/ajax/shop-item.html')}}" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                                        </div>
                ...
                <div class="col_one_third subscribe-widget">
                    ...
                    <form id="widget-subscribe-form2" action="{{ asset('web/canvas/include/subscribe.php')}}" method="post" class="nobottommargin">
                ...
                <ul class="clients-grid grid-6 nobottommargin clearfix">
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/1.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/2.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/3.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/4.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/5.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/6.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/7.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/8.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/9.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/10.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/11.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/12.png')}}" alt="Clients"></a></li>"
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/13.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/14.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/15.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/16.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/19.png')}}" alt="Clients"></a></li>
                    <li><a href="#"><img src="{{ asset('web/canvas/images/clients/logo/18.png')}}" alt="Clients"></a></li>
                </ul>
            ...
            <div class="section notopborder nobottomborder nomargin nopadding nobg footer-stick">
                <div class="container clearfix">
                    ...
                    <div class="col_half nobottommargin topmargin">
                        <img src="{{ asset('web/canvas/images/services/4.jpg') }}" alt="Image" class="nobottommargin">
                    </div>
                    ...
                    <div class="col_half subscribe-widget nobottommargin col_last">
                        ...
                        <div class="widget-subscribe-form-result"></div>
                        <form id="widget-subscribe-form3" action="{{ asset('web/canvas/include/subscribe.php')}}" method="post" class="nobottommargin">
