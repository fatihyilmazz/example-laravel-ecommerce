...
@section('content')
    ...
    <section id="page-title">
        <div class="container clearfix">
            <h1>{{ $product->translationForCurrentLocale->name }}</h1>
        </div>
                ...
                <div class="single-product">
                    ...
                    <div class="product">
                                    ...
                                    <div class="flexslider">
                                        <div class="slider-wrap" data-lightbox="gallery">
                                            @forelse($product->images as $image)
                                                <div class="slide" data-thumb="{{ asset(env('IMAGE_PATH_PRODUCT', \App\Media::DEFAULT_IMAGE_PATH_PRODUCT) . $image->source) }}"                                                         title="{{ $media->content->title }}">
                                                    <img src="{{ asset(env('IMAGE_PATH_PRODUCT', \App\Media::DEFAULT_IMAGE_PATH_PRODUCT) . $image->source) }}" alt="{{ $image->content->alt }}">
                                                </div>
                                            @empty
                                                <div class="slide" data-thumb="{{ asset('images/no-image.png') }}">
                        ...
                        <div class="col_two_fifth product-desc">
                            ...
                            ============================================= -->
                            <p>
                                {{ $product->translationForCurrentLocale->short_description }}
                            </p>
                            <ul class="iconlist">
