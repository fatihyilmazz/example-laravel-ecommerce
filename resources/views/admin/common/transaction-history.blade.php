                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    {{ html()
                                        ->select('subject_id')
                                        ->class(['form-control select2 d-block w-100', 'is-invalid' => $errors->has('subject_id')])
                                        ->options($subjects)
                ...
                @foreach($transactions as $transaction)
                    <tr class="table-row-id-{{ $transaction->id }}">
                        ...
                        <td>
                            ...
                            @else
                                <a href="{{ route("admin.{$modelNamePlural}.edit", ["{$modelVariableName}" => $transaction->subject->id]) }}">{{ $transaction->subject->name }}</a>
                            @endif
                        </td>
                        <td>
