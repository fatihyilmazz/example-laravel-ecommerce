...
{{--                                    15.7071068,15.2928932 L19.7071068,19.2928932 C20.0976311,19.6834175 20.0976311,20.3165825 19.7071068,20.7071068 C19.3165825,21.0976311--}}
{{--                                    18.6834175,21.0976311 18.2928932,20.7071068 L14.2928932,16.7071068 Z"--}}
{{--                                  id="Path-2"--}}
{{--                                  fill="#000000"--}}
{{--                                  fill-rule="nonzero"--}}
{{--                                  opacity="0.3"--}}
...
{{--                                    11,16 Z M11,18 C7.13400675,18 4,14.8659932 4,11 C4,7.13400675 7.13400675,4 11,4 C14.8659932,4 18,7.13400675 18,11 C18,14.8659932 14.8659932,18--}}
{{--                                    11,18 Z"--}}
{{--                                  id="Path"--}}
{{--                                  fill="#000000"--}}
{{--                                  fill-rule="nonzero"--}}
...
{{--                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                            <rect id="bound" x="0" y="0" width="24" height="24"/>--}}
{{--                            <path d="M2.56066017,10.6819805 L4.68198052,8.56066017 C5.26776695,7.97487373 6.21751442,7.97487373 6.80330086,8.56066017 L8.9246212,10.6819805C9.51040764,11.267767 9.51040764,12.2175144--}}
{{--                            8.9246212,12.8033009 L6.80330086,14.9246212 C6.21751442,15.5104076 5.26776695,15.5104076 4.68198052,14.9246212 L2.56066017,12.8033009 C1.97487373,12.2175144 1.97487373,11.267767--}}
{{--                            2.56066017,10.6819805 Z M14.5606602,10.6819805 L16.6819805,8.56066017 C17.267767,7.97487373 18.2175144,7.97487373 18.8033009,8.56066017 L20.9246212,10.6819805 C21.5104076,11.267767--}}
{{--                            21.5104076,12.2175144 20.9246212,12.8033009 L18.8033009,14.9246212 C18.2175144,15.5104076 17.267767,15.5104076 16.6819805,14.9246212 L14.5606602,12.8033009 C13.9748737,12.2175144 13.9748737,11.267767 14.5606602,10.6819805 Z"--}}
...
{{--        </div>--}}
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
            <span class="kt-header__topbar-icon">
                <img class="" src="{{ asset("images/common/flags/{$app->getLocale()}.svg") }}" alt=""/>
            </span>
            </div>
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <li class="kt-nav__item {{$localeCode === $app->getLocale() ? 'kt-nav__item--active' : ''}}">
                            <a rel="{{$localeCode === $app->getLocale() ? 'canonical' : 'alternate'}}"
                               hreflang="{{ $localeCode }}"
                               href="{{ LaravelLocalization::getLocalizedURL($localeCode, __('routes.admin.prefix', [], $localeCode), [], true) }}"
                               class="kt-nav__link"
                            >
                                <span class="kt-nav__link-icon">
                                    <img src="{{ asset("images/common/flags/{$localeCode}.svg") }}" alt="{{ $properties['native'] }}"/>
                                </span>
...
{{--                    </div>--}}
                ...
                <div class="kt-notification">
                    <a href="{{ route('admin.admins.edit', ['admin' => Auth::id()]) }}"
                       class="kt-notification__item">
                        <div class="kt-notification__item-icon">
                            <i class="flaticon2-calendar-3 kt-font-success"></i>
                        </div>
                        <div class="kt-notification__item-details">
                            <div class="kt-notification__item-title kt-font-bold">{{ __('constant.my_profile') }}</div>
                        </div>
                    </a>
