 ...
 * Generated for Laravel 7.12.0 on 2020-07-19 10:48:32.
 *
...
namespace App\Facades { 
    ...
    class FileFacade {
         ...
         * @static 
         */ 
        public static function upload($path, $fileName, $file)
        {
                        /** @var \App\Services\FileService $instance */
         ...
         * @static 
         */ 
        public static function uploadBase64File($path, $base64String)
        {
                        /** @var \App\Services\FileService $instance */
                        return $instance->uploadBase64File($path, $base64String);
        }
...
namespace Cocur\Slugify\Bridge\Laravel { 
    ...
    class SlugifyFacade {
        ...
        {
                        /** @var \Cocur\Slugify\Slugify $instance */
                        return $instance->slugify($string, $options);
        }
        ...
        {
                        /** @var \Cocur\Slugify\Slugify $instance */
                        return $instance->addRule($character, $replacement);
        }
        ...
        {
                        /** @var \Cocur\Slugify\Slugify $instance */
                        return $instance->addRules($rules);
        }
        ...
        {
                        /** @var \Cocur\Slugify\Slugify $instance */
                        return $instance->activateRuleSet($ruleSet);
        }
...
namespace  { 
    ...
    class FileFacade extends \App\Facades\FileFacade {}
