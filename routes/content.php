...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localize', 'localeSessionRedirect' ]], static function() {
    Route::prefix(__('routes.admin.prefix'))->namespace("Admin\Content")->name('admin.')->group(static function () {
        Route::middleware('auth:admin')->group(static function () {
            $routes = [
                ['model' => 'menu', 'options' => ['index', 'create', 'store', 'edit', 'update', 'destroy']],
                ['model' => 'menu_group', 'options' => ['index', 'create', 'store', 'edit', 'update', 'destroy']],
                ['model' => 'page', 'options' => ['index', 'create', 'store', 'edit', 'update', 'destroy']],
                ['model' => 'slider', 'options' => ['index', 'create', 'store', 'edit', 'update', 'destroy']],
            ];
