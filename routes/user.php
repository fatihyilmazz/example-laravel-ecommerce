...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localize', 'localeSessionRedirect' ]], static function() {
    ...
    Route::prefix(__('routes.admin.prefix'))->namespace("Admin\User")->name('admin.')->group(static function () {
        Route::middleware('auth:admin')->group(static function () {
            $routes = [
                ['model' => 'admin', 'options' => ['index', 'create', 'store', 'edit', 'update', 'destroy']],
                ['model' => 'user', 'options' => ['index', 'create', 'store', 'edit', 'update', 'destroy']],
                ['model' => 'role', 'options' => ['index', 'create', 'store', 'edit', 'update', 'destroy']]
            ];
